...
- 머신러닝
    - 인공지능 하위 집합
    - 통계적 방법을 이용, 기계가 학습시키는 기계를 학습시키는 인공지능 기술
...
(mlvenv) PS C:\Source\iot_dataanalysis-2025>
```

- 가상환경은 깃허브에 올라가지 않도록 처리
- .gitignore /mlvenv 추가 후 깃허브 우선 푸시
